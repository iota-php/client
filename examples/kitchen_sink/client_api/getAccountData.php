...
if(isAjax())
{
    ...
    $security = \Techworker\IOTA\Type\SecurityLevel::fromValue($_POST['security']);
        ...
        $result = $iota->getClientApi()->getAccountData(
            $node, $seed, $startIndex, $security
        );
