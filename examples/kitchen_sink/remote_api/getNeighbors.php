...
if(isAjax())
{
    try {
        ...
        $result = $iota->getRemoteApi()->getNeighbors(
            $node
        );
...
<main role="main" class="container">
    ...
    <div style="border: 1px solid #f0f0f0; padding: 10px; margin-bottom: 20px;">
        <p>Returns the set of neighbors you are connected with, as well as their
activity count. The activity counter is reset after restarting IRI.</p>
        <p><pre>public function getNeighbors(
    Techworker\IOTA\Node $node
) : \Techworker\IOTA\RemoteApi\Commands\GetNeighbors\Response</pre></p>
    </div>
