...
<main role="main" class="container">
    ...
    <div style="border: 1px solid #f0f0f0; padding: 10px; margin-bottom: 20px;">
        <p>Tip selection which returns trunkTransaction and branchTransaction. The input
...
transactions).</p>
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" name="numWalks" id="numWalks" value="null">
    </div>
    <div class="form-group">
