...
if(isAjax())
{
    ...
    $neighborUris = array_map('trim', array_filter(explode("\n", $_POST['neighborUris'])));
        ...
        $result = $iota->getRemoteApi()->removeNeighbors(
            $node, $neighborUris
        );
...
<main role="main" class="container">
    ...
    <div style="border: 1px solid #f0f0f0; padding: 10px; margin-bottom: 20px;">
        <p>Removes a list of neighbors to your node. This is only temporary, and if you
have your neighbors added via the command line, they will be retained after
you restart your node.</p>
        <p><pre>public function removeNeighbors(
    Techworker\IOTA\Node $node,
    array $neighborUris
) : \Techworker\IOTA\RemoteApi\Commands\RemoveNeighbors\Response</pre></p>
    </div>
