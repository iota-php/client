...
<main role="main" class="container">
    ...
    <div style="border: 1px solid #f0f0f0; padding: 10px; margin-bottom: 20px;">
        <p>This method attaches the specified transactions to the Tangle by doing Proof
...
POW will be performed locally by one of the PowInterface implementations.</p>
        <p><pre>public function attachToTangle(
    Techworker\IOTA\Node $node,
    array $transactions,
    Techworker\IOTA\Type\TransactionHash $trunkTransactionHash,
    Techworker\IOTA\Type\TransactionHash $branchTransactionHash,
    int $minWeightMagnitude
) : \Techworker\IOTA\RemoteApi\Commands\AttachToTangle\Response</pre></p>
    </div>
    ...
    <div class="form-group">
        <label for="branchTransactionHash">branchTransactionHash</label>
        <input type="text" class="form-control" id="branchTransactionHash" name="branchTransactionHash" aria-describedby="branchTransactionHash" placeholder="" value="">
    </div>
    <div class="form-group">
