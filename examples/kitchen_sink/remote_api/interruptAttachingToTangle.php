...
if(isAjax())
{
    try {
        ...
        $result = $iota->getRemoteApi()->interruptAttachingToTangle(
            $node
        );
...
<main role="main" class="container">
    ...
    <div style="border: 1px solid #f0f0f0; padding: 10px; margin-bottom: 20px;">
        <p>Interrupts and completely aborts the attachToTangle process.</p>
        <p><pre>public function interruptAttachingToTangle(
    Techworker\IOTA\Node $node
) : \Techworker\IOTA\RemoteApi\Commands\InterruptAttachingToTangle\Response</pre></p>
    </div>
